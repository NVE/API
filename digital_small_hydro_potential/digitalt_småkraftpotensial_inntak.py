...
def digitalt_småkraftpotensial_inntak():
    # URL of the service, WMS
    url = 'https://kart.nve.no/enterprise/rest/services/Smakraftverk1/MapServer/1/query'
    ...
    gdf.to_excel("digitalt_småkraftpotensial_inntak.xlsx", index=False)
