...
def flow_restrictions():
    # URL of the service, WMS
    url = 'https://gis3.nve.no/map/rest/services/Mapservices/Manregl_Vannkraft/MapServer/4/query'
    ...
    gdf.to_excel("flow_restrictions.xlsx", index=False)
